...
if locale == "enUS" then
    ...
    -- Tips
    L["SPELLWHISPER TIPS"] =
        "|cFFBA55D3SpellWhisper|r Tips:Use |cFF00BFFF/spellwhisper|r |cFFFF4500gui|r or |cFF00BFFF/sw|r |cFFFF4500gui|r open Option Interface, Use |cFF00BFFF/spellwhisper|r |cFFFF0000in|r or |cFF00BFFF/sw|r |cFFFF0000in|r for Delay Task."
    -- 输出格式化字符串
...
elseif locale == "zhCN" then
    ...
    -- Tips
    L["SPELLWHISPER TIPS"] =
        "|cFFBA55D3SpellWhisper|r命令行提示：使用|cFF00BFFF/spellwhisper|r |cFFFF4500gui|r或者|cFF00BFFF/sw|r |cFFFF4500gui|r打开设置窗口，使用|cFF00BFFF/spellwhisper|r |cFFFF0000in|r或者|cFF00BFFF/sw|r |cFFFF0000in|r新建延时任务。"
    -- 仇恨目标类型
    L["worldboss"] = "BOSS"
    L["elite"] = "精英"
    L["all"] = "全部"
	...
	L["Gift of Life"] = "生命赐福"]]
    -- 载入提示文字
    L["|cFFBA55D3SpellWhisper|r v%s|cFFB0C4DE is Loaded.|r"] =
        "|cFFBA55D3SpellWhisper|r v%s已|cFFB0C4DE成功|r加载！"
    ...
    L["|cFFBA55D3SpellWhisper|r v%s is |cFFFF4C00Out of date|r. Goto %s for |cFFF48CBANew Version.|r"] =
        "|cFFBA55D3SpellWhisper|r v%s已|cFFFF4C00过期|r，请用|cFF00FFFF桃乐豆|r|cFFFFF468更新|r或前往%s|cFFFFF468下载|r|cFFF48CBA最新版本|r。"
    L["<|cFFBA55D3SW|r>Start Check Team Member's |cFFBA55D3SpellWhisper|r Version."] =
        "<|cFFBA55D3SW|r>开始检查团队成员SpellWhisper插件版本。"
    L["<|cFFBA55D3SW|r>Don't Have Any Team Member(s)."] = "<|cFFBA55D3SW|r>不在一个队伍或团队中。"
    L["<|cFFBA55D3SW|r>Can't Check |cFFBA55D3SpellWhisper|r Version In Battleground."] =
        "<|cFFBA55D3SW|r>无法在战场中检查SpellWhisper版本。"
    L["<|cFFBA55D3SW|r>Please Enable |cFFBA55D3SpellWhisper|r First."] =
        "<|cFFBA55D3SW|r>请先启用|cFFBA55D3SpellWhisper|r插件。"
    -- Slash Command提示文字
    L["<|cFFBA55D3SW|r>Can NOT Open |cFFBA55D3SpellWhisper|r GUI when you in COMBAT."] =
        "<|cFFBA55D3SW|r>战斗中无法打开|cFFBA55D3SpellWhisper|r设置界面。"
    L["|cFFBA55D3SpellWhisper|r Delay Command Tips:Use |cFF00BFFF/spellwhisper|r |cFFFF0000in|r |cFFCCA4E3[Seconds] [Task]|r or |cFF00BFFF/sw|r |cFFCCA4E3in [Seconds] [Task]|r create a Delay Task."] =
        "|cFFBA55D3SpellWhisper|r使用说明：使用|cFF00BFFF/spellwhisper|r |cFFFF0000in|r |cFFCCA4E3[Seconds] [Task]|r或者|cFF00BFFF/sw|r |cFFCCA4E3in [Seconds] [Task]|r新建延时任务。"
    L["|cFFBA55D3SpellWhisper|r Delay Command: |cFFCCA4E3%d|r [seconds] later do |cFFCCA4E3[%s]|r Task."] =
        "|cFFBA55D3SpellWhisper|r：|cFFCCA4E3[%d]|r秒后执行|cFFCCA4E3[%s]|r任务。"
    L["|cFFBA55D3SpellWhisper|r Delay Command Tips: Please Input |cFF00E09EValid|r |cFFCCA4E3[Seconds]|r and |cFF00E09ELegal|r |cFFCCA4E3[Command]|r!"] =
        "|cFFBA55D3SpellWhisper|r使用说明：请输入|cFF00E09E有效|r的|cFFCCA4E3[Seconds]|r和|cFF00E09E合法|r的|cFFCCA4E3[Command]！"
    ...
    -- Config界面文字
    L["|cFFFFC040By:|r |cFF9382C9Aoikaze|r-|cFFFF66FFZeroZone|r-|cFFDE2910CN|r"] =
        "|cFFFFC040By:|r |cFF9382C9Aoikaze|r-|cFFFF66FF零界|r-|cFFDE2910CN|r"
    ...
    L["|cFF00FF00Shift+Right|r to Restore Minimap Icon Position"] =
        "|cFF00FF00Shift+右键|r重置小地图按钮位置"
...
elseif locale == "zhTW" then -- Taiwan is a part of China forever
    ...
    -- Tips
    L["SPELLWHISPER TIPS"] =
        "|cFFBA55D3SpellWhisper|r命令列提示：使用|cFF00BFFF/spellwhisper|r |cFFFF4500gui|r或者|cFF00BFFF/sw|r |cFFFF4500gui|r打開設置視窗，使用|cFF00BFFF/spellwhisper|r |cFFFF0000in|r或者|cFF00BFFF/sw|r |cFFFF0000in|r新建延時任務。"
    -- 仇恨目標類型
    L["worldboss"] = "BOSS"
    L["elite"] = "精英"
    L["all"] = "全部"
    ...
    -- 載入提示文字
    L["|cFFBA55D3SpellWhisper|r v%s|cFFB0C4DE is Loaded.|r"] =
        "|cFFBA55D3SpellWhisper|r v%s已|cFFB0C4DE成功|r載入！"
    L["Now is |cFF00FFFFEnabled|r."] = "當前已|cFF00FFFF啟用|r。"
    L["Now is |cFF00FFFFDisabled|r."] = "當前已|cFF00FFFF禁用|r。"
    L["|cFFBA55D3SpellWhisper|r v%s is |cFFFF4C00Out of date|r. Goto %s for |cFFF48CBANew Version.|r"] =
        "|cFFBA55D3SpellWhisper|r v%s已|cFFFF4C00過期|r，請用|cFF00FFFF桃樂豆|r|cFFFFF468更新|r或前往%s|cFFFFF468下載|r|cFFF48CBA最新版本|r。"
    L["<|cFFBA55D3SW|r>Start Check Team Member's |cFFBA55D3SpellWhisper|r Version."] =
        "<|cFFBA55D3SW|r>開始檢查團隊成員SpellWhisper外掛程式版本。"
    L["<|cFFBA55D3SW|r>Don't Have Any Team Member(s)."] = "<|cFFBA55D3SW|r>不在一個隊伍或團隊中。"
    L["<|cFFBA55D3SW|r>Can't Check |cFFBA55D3SpellWhisper|r Version In Battleground."] =
        "<|cFFBA55D3SW|r>無法在戰場中檢查SpellWhisper版本。"
    L["<|cFFBA55D3SW|r>Please Enable |cFFBA55D3SpellWhisper|r First."] =
        "<|cFFBA55D3SW|r>請先啟用|cFFBA55D3SpellWhisper|r外掛程式。"
    -- Slash Command提示文字
    L["<|cFFBA55D3SW|r>Can NOT Open |cFFBA55D3SpellWhisper|r GUI when you in COMBAT."] =
        "<|cFFBA55D3SW|r>戰鬥中無法打開|cFFBA55D3SpellWhisper|r設置介面。"
    L["|cFFBA55D3SpellWhisper|r Delay Command Tips:Use |cFF00BFFF/spellwhisper|r |cFFFF0000in|r |cFFCCA4E3[Seconds] [Task]|r or |cFF00BFFF/sw|r |cFFCCA4E3in [Seconds] [Task]|r create a Delay Task."] =
        "|cFFBA55D3SpellWhisper|r使用說明：使用|cFF00BFFF/spellwhisper|r |cFFFF0000in|r |cFFCCA4E3[Seconds] [Task]|r或者|cFF00BFFF/sw|r |cFFCCA4E3in [Seconds] [Task]|r新建延時任務。"
    L["|cFFBA55D3SpellWhisper|r Delay Command: |cFFCCA4E3%d|r [seconds] later do |cFFCCA4E3[%s]|r Task."] =
        "|cFFBA55D3SpellWhisper|r：|cFFCCA4E3[%d]|r秒後執行|cFFCCA4E3[%s]|r任務。"
    L["|cFFBA55D3SpellWhisper|r Delay Command Tips: Please Input |cFF00E09EValid|r |cFFCCA4E3[Seconds]|r and |cFF00E09ELegal|r |cFFCCA4E3[Command]|r!"] =
        "|cFFBA55D3SpellWhisper|r使用說明：請輸入|cFF00E09E有效|r的|cFFCCA4E3[Seconds]|r和|cFF00E09E合法|r的|cFFCCA4E3[Command]！"
